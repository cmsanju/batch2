package com.cts.irctc.skeleton;
...
public class SkeletonValidator {
	...
	public SkeletonValidator() {
		validateClassName("com.cts.irctc.IRCTCApplication");
		validateClassName("com.cts.irctc.controller.ReservationController");
		
		validateClassName("com.cts.irctc.model.Reservation");
		
		validateClassName("com.cts.irctc.exception.ReservationException");
		
		validateClassName("com.cts.irctc.exception.ReservationExceptionAdvice");
		
		validateClassName("com.cts.irctc.service.IRCTCService");
		
		
		validateMethodSignature("showHomepage:String,bookingForm:String,submitForm:String","com.cts.irctc.controller.ReservationController");
		validateMethodSignature("reservationRequest:Reservation,validateFromToCity:boolean","com.cts.irctc.service.IRCTCService");
